(function() {
  ...
  const css = `
    ...
    #bmSplashTxt1 {
      animation: txt1Pop .5s forwards 1.3s;
    }
    #bmSplashTxt2 {
      animation: txt2Pop .5s forwards 1.8s;
    }
    ...
    /* checkbox trocada por imagem + texto */
    #bmToggleWrapper {
      display: flex;
      align-items: center;
      gap: 8px;
  ...
  setTimeout(() => {
    ...
    // overlay de confirmação POP na primeira vez
    ...
    //
    // 6) botão “Iniciar” e contador 3‑2‑1
    //
